...
###### *설치*
```
sudo bin/elasticsearch-plugin install https://github.com/nobaksan/elasticsearch-jaso-analyzer/releases/download/v7.3.0/jaso-analyzer-plugin-7.3.0.0-plugin.zip
```
